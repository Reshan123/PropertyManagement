					...
					<table class="items-list col-lg-6 table-hover" style="border-collapse:inherit;">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center font-18">
                                <td><b>Amount</b></td>
                                <td><b>$<%= request.getAttribute("amount") %></b></td>
                            </tr>
							<tr class="text-center">
                                <td><b>Total Duration</b></td>
                                <td><b><%= request.getAttribute("tDuration") %> months</b></td>
                            </tr><!-- FOR MORE PROJECTS visit: codeastro.com -->
							<tr class="text-center">
                                <td><b>Interest Rate</b></td>
                                <td><b><%= request.getAttribute("intrestRate") %>%</b></td>
                            </tr>
							<tr class="text-center">
                                <td><b>Total Interest</b></td>
                                <td><b>$<%= request.getAttribute("interest") %></b></td>
                            </tr>
							<tr class="text-center">
                                <td><b>Total Amount</b></td>
                                <td><b>$<%= request.getAttribute("totalPay") %></b></td>
                            </tr>
							<tr class="text-center">
                                <td><b>Pay Per Month (EMI)</b></td>
                                <td><b>$<%= request.getAttribute("payPerMonth") %></b></td>
                            </tr>
