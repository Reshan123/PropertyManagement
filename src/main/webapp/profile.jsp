...
<%@ page 
	import="com.PropertyManagement.User"
 %>
    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                ...
                <div class="dashboard-personal-info p-5 bg-white" style="display:flex;'">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-12">
                                <div class="user-info mt-md-50">
                                	<img src="admin/user/<%= user.getImage() %>" alt="userimage">
                                    <div class="mb-4 mt-3">
                                    ...
                                    <div class="font-18">
                                    <% if (user != null){ %>
                                        <div class="mb-1 text-capitalize"><b>Name:</b> <%=user.getName() %> </div>
                                        <div class="mb-1"><b>Email:</b> <%=user.getEmail() %> </div>
                                        <div class="mb-1"><b>Contact:</b> <%= user.getPhone() %> </div>
										<div class="mb-1 text-capitalize"><b>Role:</b> <%= user.getType() %> </div>
									<% } %>
                                    </div>
                                </div>
                            </div>
