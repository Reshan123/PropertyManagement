            ...
            <div class="container"><!-- FOR MORE PROJECTS visit: codeastro.com -->
					...
					<table class="items-list col-lg-12 table-hover" style="border-collapse:inherit;">
						...
						<!-- FOR MORE PROJECTS visit: codeastro.com -->
                            ...
                            <tr>
                                <td>
									<img src="admin/property/<%= property.getpImage() %>" alt="pimage">
                                    <div class="property-info d-table">
                                        <h5 class="text-secondary text-capitalize"><a href="propertydetail.php?pid=<?php echo $row['0'];?>"><%= property.getpTitle() %></a></h5>
                                        <span class="font-14 text-capitalize"><i class="fas fa-map-marker-alt text-success font-13"></i>&nbsp; <%= property.getpLocation() %></span>
                                        <div class="price mt-3">
											<span class="text-success">$&nbsp;<%= property.getpPrice() %></span>
										</div>
                                    </div>
								</td>
                                <td><%= property.getpBHK() %></td>
                                <td class="text-capitalize">For <%= property.getpSType() %></td>
                                <td><%= property.getpDate() %></td>
								<td class="text-capitalize"><%= property.getpStatus() %></td>
