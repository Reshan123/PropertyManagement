...
<%@ page import="com.PropertyManagement.User" %>
<!DOCTYPE html>
<html>
<head>
	...
	<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
            <div class="main-nav secondary-nav hover-success-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.jsp"><img class="nav-logo" src="images/logo/restatelg.png" alt=""></a>
                                    ...
                                    <ul class="navbar-nav mr-auto">
										...
										<li class="nav-item dropdown">
											...
											<ul class="dropdown-menu">
												...
												<li class="nav-item"> <a class="nav-link" href="Feature">Your Property</a> </li>
